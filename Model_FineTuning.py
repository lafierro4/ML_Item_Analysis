...
import numpy as np
from DataProcessor import dataitem
...
cost_model = RandomForestRegressor(n_estimators=25,max_depth=15, max_features=11, max_leaf_nodes=4,
                      min_samples_leaf=2, min_samples_split=10)
cost_model.fit(X_train_scaled,y_cost_train)

efficiency_model = RandomForestRegressor(max_depth=15, max_features=11, max_leaf_nodes=8,
